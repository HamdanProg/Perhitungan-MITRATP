...
#MENU AWAL
print('\x1bc');print('S        ###              ###');time.sleep(0.1);print('E      #     #          #     #');time.sleep(0.1);print('L     #       #        #       #');time.sleep(0.1);print('A     #       #        #       #');time.sleep(0.1);print('M');time.sleep(0.1);print('A');time.sleep(0.1);print('T       ');time.sleep(0.1);print('           #################');time.sleep(0.1);print('D          #               #');time.sleep(0.1);print('A           #             #');time.sleep(0.1);print('T             ##       ##');time.sleep(0.1);print('A               #######');time.sleep(0.1);print('N');time.sleep(0.1);print('G')
time.sleep(1)
